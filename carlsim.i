// This interface file  is used to generate a library file (.so) that will be imported in python as a python library. Swig is used as the software for generating the library.  The interface file shall be modified manually.  
// if periodic spike generator must be included thenthe header location must be included in the  swig module and a source location must be included in the setup file and then the prototype of the class or function shall be included in the interface file.
...
#include "interface/inc/carlsim.h"
#include "interface/inc/carlsim_datastructures.h"
#include "interface/inc/carlsim_definitions.h"
#include "interface/inc/carlsim_datastructures.h"
#include "interface/inc/callback.h"
#include "interface/inc/poisson_rate.h"
#include "monitor/spike_monitor.h"
#include "monitor/connection_monitor.h"
#include "monitor/group_monitor.h"
#include "interface/inc/linear_algebra.h"
#include "kernel/inc/snn.h"
#include "kernel/inc/snn_datastructures.h"
#include "kernel/inc/error_code.h"
#include "kernel/inc/snn_definitions.h"
#include "kernel/inc/spike_buffer.h"
#include "kernel/inc/cuda_version_control.h"
#include "/home/anup/swig-3.0.12/Examples/python/CARLsim4/tools/spike_generators/spikegen_from_vector.h"
